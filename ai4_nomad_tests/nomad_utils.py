...
Nomad.job.deregister_job = types.MethodType(deregister_job, Nomad.job)
Nomad.job.get_allocations = types.MethodType(get_allocations, Nomad.job)
Nomad.job.get_evaluations = types.MethodType(get_allocations, Nomad.job)
